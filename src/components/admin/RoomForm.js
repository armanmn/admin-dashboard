...
// import RoomVariationForm from "./RoomVariationForm";
...
//   const handleVariationChange = (data) => {
//     setVariations(data);
//   };
...
//       variations,
//     };
//     console.log("Submitting:", fullRoomData);
//     // Այստեղ ավելացրու DB ինտեգրում կամ API POST
//   };

//   return (
//     <form onSubmit={handleSubmit}>
//       <RoomCategorySection data={roomData} onChange={handleCategoryChange} />
//       <RoomVariationForm onChange={handleVariationChange} />
//       <button type="submit">Պահպանել սենյակը</button>
//     </form>
//   );
// };
